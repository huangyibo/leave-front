...
export var ApiService = (function () {
    ...
    ApiService.prototype.put = function (path, body) {
        if (body === void 0) { body = {}; }
        return this.http.put("" + environment.api_url + path, JSON.stringify(body), { headers: this.setHeader() })
            .catch(this.formatErrors)
            .map(function (res) { return res.json(); });
    };
    ...
    ApiService.prototype.delete = function (path) {
        return this.http.delete("" + environment.api_url + path, { headers: this.setHeader() })
            .catch(this.formatErrors)
            .map(function (res) { return res.json(); });
    };
...
//# sourceMappingURL=F:/复旦大学/两军大请假销假系统/version/v-20170710/smmu/leave/src/src/app/shared/services/api.serivce.js.map