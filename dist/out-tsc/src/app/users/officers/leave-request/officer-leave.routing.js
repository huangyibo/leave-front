...
export var OfficerLeaveRoutingModule = (function () {
    function OfficerLeaveRoutingModule() {
    }
    OfficerLeaveRoutingModule = __decorate([
        NgModule({
            imports: [
                routes
            ],
    ...
    return OfficerLeaveRoutingModule;
}());
//# sourceMappingURL=F:/复旦大学/两军大请假销假系统/version/v-20170710/smmu/leave/src/src/app/users/officers/leave-request/officer-leave.routing.js.map