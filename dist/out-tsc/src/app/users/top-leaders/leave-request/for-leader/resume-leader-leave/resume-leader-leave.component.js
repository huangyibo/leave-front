...
export var ResumeLeaderLeaveComponent = (function () {
    function ResumeLeaderLeaveComponent(breadcrumbService, userService, toasterService, ref, leaveRequestService) {
    ...
    ResumeLeaderLeaveComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ResumeLeaderLeaveComponent.prototype.ngOnDestroy = function () {
        this.breadcrumbService.clear();
    };
    ResumeLeaderLeaveComponent.prototype.editLeave = function (leaveId) {
        var _this = this;
        var i = 0;
    ...
    ResumeLeaderLeaveComponent.prototype.getPage = function (page_no) {
        var _this = this;
        this.isLoading = true;
    ...
    ResumeLeaderLeaveComponent.prototype.fakeLeave = function (leaveId) {
        var _this = this;
        this.isLoading = true;
    ...
    ResumeLeaderLeaveComponent.prototype.remindSignLeave = function (leaveId, user_id, user_name) {
        this.popToast('success', null, '您已成功提醒' + user_name + '签到！');
    };
    ResumeLeaderLeaveComponent.prototype.popToast = function (type, title, body) {
        var toast = {
            type: type,
            title: title,
            body: body
    ...
    ResumeLeaderLeaveComponent = __decorate([
        Component({
    ...
    return ResumeLeaderLeaveComponent;
}());
//# sourceMappingURL=F:/复旦大学/两军大请假销假系统/version/v-20170710/smmu/leave/src/src/app/users/top-leaders/leave-request/for-leader/resume-leader-leave/resume-leader-leave.component.js.map