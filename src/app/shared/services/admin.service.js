...
var AdminService = (function () {
    function AdminService(apiService, http, adminJwtService) {
        ...
        this.currentAdminSubject = new rxjs_1.BehaviorSubject(new admin_model_1.Admin());
    ...
    AdminService.prototype.purgeAuth = function () {
        ...
        this.currentAdminSubject.next(new admin_model_1.Admin());
    ...
    AdminService.prototype.invalidate = function () {
        ...
        if (currentAdmin.level === 'two') {
            return rxjs_1.Observable.throw(new Error('该管理员权限不满足!'));
        }
    };
